...
public class PageVo {
	...
	private int cartLimit;		//한 페이지에 보여줄 게시글 최대갯수
	...
	//생성자
	public PageVo(int listCount , int currentPage, int pageLimit, int cartLimit) {
		...
		this.maxPage = (int)Math.ceil( (double)listCount / cartLimit );
	...
	public String toString() {
		return "PageVo [listCount=" + listCount + ", currentPage=" + currentPage + ", pageLimit=" + pageLimit
				+ ", cartLimit=" + cartLimit + ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage="
				+ endPage + "]";
	}
